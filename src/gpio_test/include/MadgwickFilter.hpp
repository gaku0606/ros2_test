...
inline void MadgwickFilter::MadgwickAHRSupdate(double gx, double gy, double gz, double ax, double ay, double az, double mx, double my, double mz) {
    ...
    static double recipNorm;
    static double s0, s1, s2, s3;
    static double qDot1, qDot2, qDot3, qDot4;
    static double hx, hy;
    static double _2q0mx, _2q0my, _2q0mz, _2q1mx, _2bx, _2bz, _4bx, _4bz, _2q0, _2q1, _2q2, _2q3, _2q0q2, _2q2q3, q0q0, q0q1, q0q2, q0q3, q1q1, q1q2, q1q3, q2q2, q2q3, q3q3;
    ...
    if(!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
        ...
        double deltaA = fabs(acc_norm - 1.00f);
...
inline void MadgwickFilter::MadgwickAHRSupdate(double *gyro, double *acc, double *mag){
    ...
    static double gx = 0, gy = 0, gz = 0.0f, ax = 0.0f, ay = 0.0f, az = 0.0f, mx = 0.0f, my = 0.0f, mz = 0.0f;
    static double acc_norm;
    static double deltaT = 0.0f;
    static unsigned int newTime = 0, oldTime = 0;
    static double recipNorm;
